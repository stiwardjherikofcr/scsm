...
public class TablaMicrocurriculoJpaController implements Serializable {
    ...
    public void create(TablaMicrocurriculo tablaMicrocurriculo) throws PreexistingEntityException, Exception {
        ...
        if (tablaMicrocurriculo.getTablaMicrocurriculoInfoList() == null) {
            tablaMicrocurriculo.setTablaMicrocurriculoInfoList(new ArrayList<>());
        }
        if (tablaMicrocurriculo.getEncabezadoTablaList() == null) {
            tablaMicrocurriculo.setEncabezadoTablaList(new ArrayList<>());
        }
        ...
        try {
            ...
            List<TablaMicrocurriculoInfo> attachedTablaMicrocurriculoInfoList = new ArrayList<>();
            ...
            List<EncabezadoTabla> attachedEncabezadoTablaList = new ArrayList<>();
    ...
    public void edit(TablaMicrocurriculo tablaMicrocurriculo) throws IllegalOrphanException, NonexistentEntityException, Exception {
        ...
        try {
            ...
            List<TablaMicrocurriculoInfo> attachedTablaMicrocurriculoInfoListNew = new ArrayList<>();
            ...
            List<EncabezadoTabla> attachedEncabezadoTablaListNew = new ArrayList<>();
