...
CREATE TABLE IF NOT EXISTS `scsm`.`tabla_seccion` (
  ...
  PRIMARY KEY (`tabla_id`, `seccion_microcurriculo_id`),
...
-- -----------------------------------------------------
-- Table `scsm`.`tabla_info`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `scsm`.`tabla_info` (
  `fila` INT(11) NOT NULL,
  `columna` INT(11) NOT NULL,
  `contenido_id` INT(11) NOT NULL,
  `tabla_seccion_tabla_id` INT(11) NOT NULL,
  `tabla_seccion_seccion_microcurriculo_id` INT(11) NOT NULL,
  PRIMARY KEY (`fila`, `columna`),
  INDEX `fk_tabla_microcurriculo_info_fila_contenido1_idx` (`contenido_id` ASC),
  INDEX `fk_tabla_info_tabla_seccion1_idx` (`tabla_seccion_tabla_id` ASC, `tabla_seccion_seccion_microcurriculo_id` ASC),
  CONSTRAINT `fk_tabla_microcurriculo_info_fila_contenido1`
    FOREIGN KEY (`contenido_id`)
    REFERENCES `scsm`.`contenido` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_tabla_info_tabla_seccion1`
    FOREIGN KEY (`tabla_seccion_tabla_id` , `tabla_seccion_seccion_microcurriculo_id`)
    REFERENCES `scsm`.`tabla_seccion` (`tabla_id` , `seccion_microcurriculo_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `scsm`.`cumplimiento` (
  ...
  INDEX `fk_unidad_contenido1_idx` (`contenido_id` ASC),
  INDEX `fk_cumplimiento_materia_periodo_grupo1_idx` (`materia_periodo_grupo_id` ASC),
  PRIMARY KEY (`materia_periodo_grupo_id`),
  CONSTRAINT `fk_unidad_contenido1`
    FOREIGN KEY (`contenido_id`)
    REFERENCES `scsm`.`contenido` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
