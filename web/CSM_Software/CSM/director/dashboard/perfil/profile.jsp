<%-- 
    Document   : profile
    Created on : 15-jun-2021, 23:38:33
    Author     : Stiward
--%>
                                ...
                                <ul class="dropdown-menu dropdown-user animated fadeIn">
                                    <div class="dropdown-user-scroll scrollbar-outer">
                                        ...
                                        <li>
                                            ...
                                            <div class="dropdown-divider"></div>
                                            <a class="dropdown-item" href="edit-profile.jsp">Account Setting</a>
                                            <div class="dropdown-divider"></div>
                                            ...
                                            <table class="table table-hover">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><%=user.getDocente().getDepartamentoId().getNombreDepartamento()%></td>
                                                    </tr>
                                                    <tr>
                                                        <td><b>Programa</b></td>
                                                    ...
                                                    <tr>
                                                        <td><b>Estado</b></td>
                                                        <td><%=(user.getDocente().getEstado() == 1) ? "Activo" : "Inactivo"%></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
