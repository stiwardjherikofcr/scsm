...
<html lang="en">
    ...
    <body>
        ...
        <!-- jQuery Sparkline -->
        <script src="<%=request.getContextPath()%>/CSM_Software/assets/js/plugin/jquery.sparkline/jquery.sparkline.min.js"></script>

        <!-- Datatables -->
        <script src="<%=request.getContextPath()%>/CSM_Software/assets/js/plugin/datatables/datatables.min.js"></script>

        <!-- Bootstrap Notify -->
        <script src="<%=request.getContextPath()%>/CSM_Software/assets/js/plugin/bootstrap-notify/bootstrap-notify.min.js"></script>
