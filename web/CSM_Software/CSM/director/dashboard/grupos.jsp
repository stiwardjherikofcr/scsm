                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="form-button-action">
                                                                <a href="<%=request.getContextPath()%>/ControladorGrupos?accion=Editar&grupo=<%=materia.getMateriaPeriodoGrupoPK().getGrupo()%>&docente_codigo=<%=materia.getDocente().getCodigoDocente()%>&anio=<%=materia.getMateriaPeriodoGrupoPK().getMateriaPeriodoAnio()%>&semestre_anio=<%=materia.getMateriaPeriodoGrupoPK().getMateriaPeriodoSemestreAnio()%>&codigo_materia=<%=materia.getMateriaPeriodoGrupoPK().getMateriaPeriodoMateriaCodigoMateria()%>&codigoPensum=<%=materia.getMateriaPeriodoGrupoPK().getMateriaPeriodoMateriaPensumCodigo()%>">
                                                                ...
                                                                <a href="<%=request.getContextPath()%>/ControladorGrupos?accion=Eliminar&grupo=<%=materia.getMateriaPeriodoGrupoPK().getGrupo()%>&docente_codigo=<%=materia.getDocente().getCodigoDocente()%>&anio=<%=materia.getMateriaPeriodoGrupoPK().getMateriaPeriodoAnio()%>&semestre_anio=<%=materia.getMateriaPeriodoGrupoPK().getMateriaPeriodoSemestreAnio()%>&codigo_materia=<%=materia.getMateriaPeriodoGrupoPK().getMateriaPeriodoMateriaCodigoMateria()%>&codigoPensum=<%=materia.getMateriaPeriodoGrupoPK().getMateriaPeriodoMateriaPensumCodigo()%>">
                                ...
                                <div class="">
                                    <div class="card">
                                        ...
                                        <div class="card-body pb-0 ">
                                            <form action="<%=request.getContextPath()%>/ControladorGrupos" method="GET">
